...
unsigned int chip8_logo_ch8_len = 494;
...
unsigned int __4_flags_ch8_len = 1041;
...
unsigned int __3_corax__ch8_len = 761;
...
unsigned int keypad_ch8_len = 913;
